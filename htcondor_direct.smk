...
rule pilot:
    ...
    shell:
        ...
        "&& cp $WORKDIR/workflow/calibration_file.txt this_chunk_index.txt "
        "&& sed "
        ...
        "&& END=$(date +%s) "
        '&& echo "DURATION_SECONDS=$((END-START))" | tee $WORKDIR/results/htcondor_direct_pilot_timing.txt'
